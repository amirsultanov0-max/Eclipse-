...
## Official validation set — 2026-09-22 21:30

Read-only evaluation of `sr_data200mb_s1339_best.pt` (full file) (step 10,000) on `data/tinystories_valid.txt`, reserved and untouched since Stage 1. One deterministic pass, every token scored exactly once — no sampling, no repeats.
...
- cross-check at stride 512 with 513-token windows, which scores every token: 4,796,928 tokens, loss 2.1016 (ppl 8.18) — the windowing choice is worth 0.0000 nats
...
| **this transformer, step 10,000 (512-token context)** | **2.1016** | **8.18** |
...
|---|---|---|---|
| 1-16 | 1-16 tokens | 2.8454 | 17.21 |
| 17-64 | 17-64 tokens | 2.2316 | 9.31 |
| 65-128 | 65-128 tokens | 2.0840 | 8.04 |
| 129-256 | 129-256 tokens | 2.0550 | 7.81 |
| 257-511 | 257-511 tokens | 2.0583 | 7.83 |
