...
## Official validation set — 2026-09-22 19:21

Read-only evaluation of `sr_base20mb_s1338_best.pt` (full file) (step 10,000) on `data/tinystories_valid.txt`, reserved and untouched since Stage 1. One deterministic pass, every token scored exactly once — no sampling, no repeats.
...
- cross-check at stride 512 with 513-token windows, which scores every token: 4,796,928 tokens, loss 2.2447 (ppl 9.44) — the windowing choice is worth 0.0000 nats
...
| **this transformer, step 10,000 (512-token context)** | **2.2447** | **9.44** |
...
|---|---|---|---|
| 1-16 | 1-16 tokens | 2.9364 | 18.85 |
| 17-64 | 17-64 tokens | 2.3540 | 10.53 |
| 65-128 | 65-128 tokens | 2.2274 | 9.28 |
| 129-256 | 129-256 tokens | 2.2034 | 9.06 |
| 257-511 | 257-511 tokens | 2.2057 | 9.08 |
