...
## Official validation set — 2026-09-22 21:31

Read-only evaluation of `sr_data200mb_s1339_best.pt` (clean subset) (step 10,000) on `data/tinystories_valid.txt`, reserved and untouched since Stage 1. One deterministic pass, every token scored exactly once — no sampling, no repeats.
...
- cross-check at stride 512 with 513-token windows, which scores every token: 4,766,208 tokens, loss 2.1030 (ppl 8.19) — the windowing choice is worth 0.0000 nats
...
| **this transformer, step 10,000 (512-token context)** | **2.1031** | **8.19** |
...
|---|---|---|---|
| 1-16 | 1-16 tokens | 2.8512 | 17.31 |
| 17-64 | 17-64 tokens | 2.2313 | 9.31 |
| 65-128 | 65-128 tokens | 2.0870 | 8.06 |
| 129-256 | 129-256 tokens | 2.0536 | 7.80 |
| 257-511 | 257-511 tokens | 2.0608 | 7.85 |
