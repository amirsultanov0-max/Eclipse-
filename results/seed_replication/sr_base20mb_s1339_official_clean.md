...
## Official validation set — 2026-09-22 20:49

Read-only evaluation of `sr_base20mb_s1339_best.pt` (clean subset) (step 10,000) on `data/tinystories_valid.txt`, reserved and untouched since Stage 1. One deterministic pass, every token scored exactly once — no sampling, no repeats.
...
- cross-check at stride 512 with 513-token windows, which scores every token: 4,766,208 tokens, loss 2.2138 (ppl 9.15) — the windowing choice is worth 0.0000 nats
...
| **this transformer, step 10,000 (512-token context)** | **2.2138** | **9.15** |
...
|---|---|---|---|
| 1-16 | 1-16 tokens | 2.9191 | 18.52 |
| 17-64 | 17-64 tokens | 2.3315 | 10.29 |
| 65-128 | 65-128 tokens | 2.1985 | 9.01 |
| 129-256 | 129-256 tokens | 2.1687 | 8.75 |
| 257-511 | 257-511 tokens | 2.1739 | 8.79 |
