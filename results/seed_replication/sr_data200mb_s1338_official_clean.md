...
## Official validation set — 2026-09-22 20:05

Read-only evaluation of `sr_data200mb_s1338_best.pt` (clean subset) (step 9,750) on `data/tinystories_valid.txt`, reserved and untouched since Stage 1. One deterministic pass, every token scored exactly once — no sampling, no repeats.
...
- cross-check at stride 512 with 513-token windows, which scores every token: 4,766,208 tokens, loss 2.1130 (ppl 8.27) — the windowing choice is worth 0.0000 nats
...
| **this transformer, step 9,750 (512-token context)** | **2.1131** | **8.27** |
...
|---|---|---|---|
| 1-16 | 1-16 tokens | 2.8532 | 17.34 |
| 17-64 | 17-64 tokens | 2.2403 | 9.40 |
| 65-128 | 65-128 tokens | 2.0989 | 8.16 |
| 129-256 | 129-256 tokens | 2.0658 | 7.89 |
| 257-511 | 257-511 tokens | 2.0700 | 7.92 |
