...
## Official validation set — 2026-09-22 19:23

Read-only evaluation of `sr_base20mb_s1338_best.pt` (clean subset) (step 10,000) on `data/tinystories_valid.txt`, reserved and untouched since Stage 1. One deterministic pass, every token scored exactly once — no sampling, no repeats.
...
- cross-check at stride 512 with 513-token windows, which scores every token: 4,766,208 tokens, loss 2.2472 (ppl 9.46) — the windowing choice is worth 0.0000 nats
...
| **this transformer, step 10,000 (512-token context)** | **2.2472** | **9.46** |
...
|---|---|---|---|
| 1-16 | 1-16 tokens | 2.9411 | 18.94 |
| 17-64 | 17-64 tokens | 2.3558 | 10.55 |
| 65-128 | 65-128 tokens | 2.2306 | 9.30 |
| 129-256 | 129-256 tokens | 2.2039 | 9.06 |
| 257-511 | 257-511 tokens | 2.2092 | 9.11 |
