...
## Official validation set — 2026-09-23 17:25

Read-only evaluation of `st62_d352_s1337_best.pt` (full file) (step 10,000) on `data/tinystories_valid.txt`, reserved and untouched since Stage 1. One deterministic pass, every token scored exactly once — no sampling, no repeats.
...
- cross-check at stride 512 with 513-token windows, which scores every token: 4,796,928 tokens, loss 1.9636 (ppl 7.12) — the windowing choice is worth 0.0001 nats
...
| **this transformer, step 10,000 (512-token context)** | **1.9636** | **7.13** |
...
|---|---|---|---|
| 1-16 | 1-16 tokens | 2.7512 | 15.66 |
| 17-64 | 17-64 tokens | 2.0962 | 8.13 |
| 65-128 | 65-128 tokens | 1.9473 | 7.01 |
| 129-256 | 129-256 tokens | 1.9174 | 6.80 |
| 257-511 | 257-511 tokens | 1.9166 | 6.80 |
