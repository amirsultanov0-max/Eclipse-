...
## Official validation set — 2026-09-23 19:10

Read-only evaluation of `st62_d352_s1338_best.pt` (full file) (step 10,000) on `data/tinystories_valid.txt`, reserved and untouched since Stage 1. One deterministic pass, every token scored exactly once — no sampling, no repeats.
...
- cross-check at stride 512 with 513-token windows, which scores every token: 4,796,928 tokens, loss 1.8903 (ppl 6.62) — the windowing choice is worth 0.0000 nats
...
| **this transformer, step 10,000 (512-token context)** | **1.8904** | **6.62** |
...
|---|---|---|---|
| 1-16 | 1-16 tokens | 2.6712 | 14.46 |
| 17-64 | 17-64 tokens | 2.0265 | 7.59 |
| 65-128 | 65-128 tokens | 1.8757 | 6.53 |
| 129-256 | 129-256 tokens | 1.8439 | 6.32 |
| 257-511 | 257-511 tokens | 1.8428 | 6.31 |
