...
## Official validation set — 2026-09-23 20:55

Read-only evaluation of `st62_d352_s1339_best.pt` (full file) (step 10,000) on `data/tinystories_valid.txt`, reserved and untouched since Stage 1. One deterministic pass, every token scored exactly once — no sampling, no repeats.
...
- cross-check at stride 512 with 513-token windows, which scores every token: 4,796,928 tokens, loss 1.9194 (ppl 6.82) — the windowing choice is worth 0.0001 nats
...
| **this transformer, step 10,000 (512-token context)** | **1.9194** | **6.82** |
...
|---|---|---|---|
| 1-16 | 1-16 tokens | 2.7191 | 15.17 |
| 17-64 | 17-64 tokens | 2.0584 | 7.83 |
| 65-128 | 65-128 tokens | 1.9046 | 6.72 |
| 129-256 | 129-256 tokens | 1.8708 | 6.49 |
| 257-511 | 257-511 tokens | 1.8712 | 6.50 |
