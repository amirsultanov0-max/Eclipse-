...
## Official validation set — 2026-09-23 17:29

Read-only evaluation of `st62_d352_s1337_best.pt` (clean subset) (step 10,000) on `data/tinystories_valid.txt`, reserved and untouched since Stage 1. One deterministic pass, every token scored exactly once — no sampling, no repeats.
...
- cross-check at stride 512 with 513-token windows, which scores every token: 4,766,208 tokens, loss 1.9649 (ppl 7.13) — the windowing choice is worth 0.0000 nats
...
| **this transformer, step 10,000 (512-token context)** | **1.9650** | **7.13** |
...
|---|---|---|---|
| 1-16 | 1-16 tokens | 2.7584 | 15.77 |
| 17-64 | 17-64 tokens | 2.0948 | 8.12 |
| 65-128 | 65-128 tokens | 1.9475 | 7.01 |
| 129-256 | 129-256 tokens | 1.9156 | 6.79 |
| 257-511 | 257-511 tokens | 1.9199 | 6.82 |
