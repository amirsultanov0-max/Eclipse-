...
## Official validation set — 2026-09-23 19:13

Read-only evaluation of `st62_d352_s1338_best.pt` (clean subset) (step 10,000) on `data/tinystories_valid.txt`, reserved and untouched since Stage 1. One deterministic pass, every token scored exactly once — no sampling, no repeats.
...
- cross-check at stride 512 with 513-token windows, which scores every token: 4,766,208 tokens, loss 1.8915 (ppl 6.63) — the windowing choice is worth 0.0001 nats
...
| **this transformer, step 10,000 (512-token context)** | **1.8916** | **6.63** |
...
|---|---|---|---|
| 1-16 | 1-16 tokens | 2.6749 | 14.51 |
| 17-64 | 17-64 tokens | 2.0244 | 7.57 |
| 65-128 | 65-128 tokens | 1.8766 | 6.53 |
| 129-256 | 129-256 tokens | 1.8417 | 6.31 |
| 257-511 | 257-511 tokens | 1.8462 | 6.34 |
