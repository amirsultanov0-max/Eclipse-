...
## eq63_20260925120839_pre_mps — 2026-09-25 12:24
...
- wall clock: 4.0 min (242 ms/step)

| loss (nats) | train | val | val perplexity |
|---|---|---|---|
| **final (step 1,001)** | **3.0337** | **2.9943** | **20.0** |
...
| 500 | 3.8333 | 3.6064 | 36.8 |
| 750 | 3.4187 | 3.2378 | 25.5 |
| 1,000 | 3.1193 | 2.9908 | 19.9 |
| 1,001 | 3.0337 | 2.9943 | 20.0 |
...
Logs: `eq63_20260925120839_pre_mps_training.csv`, `eq63_20260925120839_pre_mps_grad.csv`, `eq63_20260925120839_pre_mps_samples.txt` in `logs/` · checkpoints: `eq63_20260925120839_pre_mps_best.pt` + periodic in `ckpt_pre_mps/` (both gitignored)
