...
## eq63_20260925120839_pre_cpu — 2026-09-25 12:14
...
- wall clock: 5.6 min (338 ms/step)
...
Logs: `eq63_20260925120839_pre_cpu_training.csv`, `eq63_20260925120839_pre_cpu_grad.csv`, `eq63_20260925120839_pre_cpu_samples.txt` in `logs/` · checkpoints: `eq63_20260925120839_pre_cpu_best.pt` + periodic in `ckpt_pre_cpu/` (both gitignored)
